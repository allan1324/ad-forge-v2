...
export const TopBar: React.FC<TopBarProps> = ({ onGenerate, canGenerate, onBack, showBack, onOpenInput }) => {
  return (
          ...
          <div className="af-flex af-items-center af-gap-4">
            {showBack ? (
              ...
              <>
                ...
                <div className="lg:af-hidden">
                  <Button onClick={onOpenInput} size="lg">
                    <Icons.wand className="af-mr-2 af-h-5 af-w-5" />
                    Create Ad Kit
                  </Button>
                </div>

                {/* Convenience button on desktop */}
                <div className="af-hidden lg:af-block">
